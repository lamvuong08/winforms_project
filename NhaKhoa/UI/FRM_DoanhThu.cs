...
namespace NhaKhoa.UI
{
    public partial class FRM_DoanhThu : Form
    {
        ...
        {
            InitializeComponent();
            _hoaDonBUS = new HoaDonBUS(); // Khởi tạo BUS
            rbtnThang.Checked = true;
        }

        // Hàm xóa dữ liệu biểu đồ
        ...
        // Hàm tải dữ liệu và hiển thị biểu đồ theo quý
        ...
        // Hàm tải dữ liệu và hiển thị biểu đồ theo năm
        ...
        {
            LoadDataTheoThang(); // Mặc định khi mở form
        }
    }
}
